...
#define _1388_TADCORA_VALUE             (0x1388U) /* MTU4.TADCORA value */
/* Timer A/D Converter Start Request Cycle Set Buffer Registers A value */
#define _1388_TADCOBRA_VALUE            (0x1388U) /* MTU4.TADCOBRA value */
/* Timer A/D Converter Start Request Cycle Set Registers B value */
#define _D6D8_TADCORB_VALUE             (0xD6D8U) /* MTU4.TADCORB value */
/* Timer A/D Converter Start Request Cycle Set Buffer Registers B value */
#define _D6D8_TADCOBRB_VALUE            (0xD6D8U) /* MTU4.TADCOBRB value */
