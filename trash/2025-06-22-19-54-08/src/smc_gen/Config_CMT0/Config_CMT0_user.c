...
extern const uint16_t full_sine_zero_start[SINE_TABLE_SIZE];
 volatile uint16_t index = 0;

 const uint16_t full_sine_zero_start[1024] = {
        0,    0,    0,    0,    1,    1,    1,    2,
        2,    3,    4,    5,    6,    7,    8,    9,
...
static void r_Config_CMT0_cmi0_interrupt(void)
{
	...
	R_Config_DA0_Set_ConversionValue(full_sine_zero_start[index]);
	index++;
