...
#define _04_MTU_PCLK_256                (0x04U) /* Internal clock: counts on PCLK/256 (for MTU3,4,6,7) */
#define _06_MTU_PCLK_256                (0x06U) /* Internal clock: counts on PCLK/256 (for MTU1) */
#define _05_MTU_PCLK_1024               (0x05U) /* Internal clock: counts on PCLK/1024 (for MTU3,4,6,7) */
...
#define _04_MTU_MTCLKA                  (0x04U) /* External clock: counts on MTCLKA pin input (for MTU0,1,2,9) */
#define _06_MTU_MTCLKA                  (0x06U) /* External clock: counts on MTCLKA pin input (for MTU3,4,6,7) */
#define _05_MTU_MTCLKB                  (0x05U) /* External clock: counts on MTCLKB pin input (for MTU0,1,2,9) */
#define _07_MTU_MTCLKB                  (0x07U) /* External clock: counts on MTCLKB pin input (for MTU3,4,6,7) */
#define _06_MTU_MTCLKC                  (0x06U) /* External clock: counts on MTCLKC pin input (for MTU0,2,9) */
#define _07_MTU_MTCLKD                  (0x07U) /* External clock: counts on MTCLKD pin input (for MTU0,9) */
...
#define _04_MTU_PCLK_256                (0x04U) /* Internal clock: counts on PCLK/256 (for MTU0,2,5,9) */
#define _04_MTU_PCLK_1024               (0x04U) /* Internal clock: counts on PCLK/1024 (for MTU1) */
#define _05_MTU_PCLK_1024               (0x05U) /* Internal clock: counts on PCLK/1024 (for MTU0,5,9) */
#define _07_MTU_MTIOC1A                 (0x07U) /* External clock: counts on MTIOC1A pin output (for MTU0,5,9) */
...
/* Down-Count TRGnBN Enable (DTnBE) (n=4,7) */
...
/* Up-Count TRGnBN Enable (UTnBE) (n=4,7) */
...
/* Down-Count TRGnAN Enable (DTnAE) (n=4,7) */
...
/* Up-Count TRGnAN Enable (UTnAE) (n=4,7) */
...
/* Timer Synchronous Operation 9 (SYNC9) */
#define _00_MTU_SYNC9_OFF               (0x00U) /* MTU9.TCNT operates independently */
#define _08_MTU_SYNC9_ON                (0x08U) /* MTU9.TCNT performs synchronous operation */
...
/*
    A/D Conversion Start Request Select Register n (TADSTRGRn) (n=0,1)
*/
/* ADSMn Pin Output Enable (TADSMENn) */
#define _00_MTU_TADSMEN_DISABLE        (0x00U) /* ADSMn pin output disabled */
#define _80_MTU_TADSMEN_ENABLE         (0x80U) /* ADSMn pin output enabled */
...
#define _06_MTU_TADSTRS_TRGA6N         (0x06U) /* Source is TRGA6N */
#define _07_MTU_TADSTRS_TRGA7N         (0x07U) /* Source is TRGA7N */
...
#define _0D_MTU_TADSTRS_TRG7AN         (0x0DU) /* Source is TRG7AN */
#define _0E_MTU_TADSTRS_TRG7BN         (0x0EU) /* Source is TRG7BN */
#define _10_MTU_TADSTRS_TRG7ABN        (0x10U) /* Source is TRG7ABN */
#define _11_MTU_TADSTRS_TRGA9N         (0x11U) /* Source is TRGA9N */
#define _12_MTU_TADSTRS_TRG9N          (0x12U) /* Source is TRG9N */
#define _13_MTU_TADSTRS_TRG9AEN        (0x13U) /* Source is TRG9AEN */
#define _14_MTU_TADSTRS_TRG0AEN        (0x14U) /* Source is TRG0AEN */
#define _15_MTU_TADSTRS_TRGA09AN       (0x15U) /* Source is TRGA09AN */
#define _16_MTU_TADSTRS_TRG09N         (0x16U) /* Source is TRG09N */
